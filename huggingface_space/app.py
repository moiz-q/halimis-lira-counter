"""
Hugging Face Space deployment for Halimi's Lira Counter API.
This is a Flask API server for Turkish Lira cash detection.
"""
...
# For Hugging Face Spaces, we need to run on the port they provide
